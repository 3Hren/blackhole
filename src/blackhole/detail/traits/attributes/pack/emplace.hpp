 ...
 * It is useful when determining if argument pack is emplace pack.
 */
template<class... Args>
...
/*!
 * Helper metafunction that determines if all odd arguments is convertible
 * to `attribute::value_t`.
 * It is useful when determining if argument pack is emplace pack.
 */
template<class... Args>
