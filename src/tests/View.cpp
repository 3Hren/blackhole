...
using namespace blackhole::aux::iterator;

TEST(join_t, DefaultConstructor) {
    typedef std::vector<int> container_type;
    join_t<container_type, true> it;
    UNUSED(it);
}

TEST(join_t, EmptyIteratorEqualsIteratorWithEmptyContainers) {
    typedef std::vector<int> container_type;
    container_type c1, c2;

    join_t<container_type, true> it1;
    join_t<container_type, true> it2({ &c1, &c2 });
    EXPECT_TRUE(it1 == it2);
}

TEST(join_t, ConvertingConstructor) {
    typedef std::vector<int> container_type;
    container_type c1, c2;
...
TEST(join_t, ForwardWithEmptyFirst) {
    typedef std::vector<int> container_type;
    container_type c1 = {};
    container_type c2 = { 3, 4, 5 };
...
TEST(join_t, ForwardWithEmptyLast) {
    typedef std::vector<int> container_type;
...
TEST(join_t, ForwardLoopPostIncrement) {
    typedef std::vector<int> container_type;
    container_type c1 = { 0, 1, 2 };
    container_type c2 = { 3, 4, 5 };
