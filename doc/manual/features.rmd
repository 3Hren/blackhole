...
Blackhole supports the next sinks out of the box:
  ...
  * [Null](sink/null). Transports messages to nowhere. Can be useful for testing or benchmarks.
  * [Socket](sink/socket). Sends messages through the network. Supports TCP and UDP.
